...
class NoteStore_manageNotebookShares_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\EDAM\NoteStore\ManageNotebookSharesResult',
        ),
        1 => array(
            'var' => 'userException',
            'isRequired' => false,
    ...
    /**
     * @var \EDAM\NoteStore\ManageNotebookSharesResult
     */
    public $success = null;
    /**
    ...
    {
        return 'NoteStore_manageNotebookShares_result';
    }
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \EDAM\NoteStore\ManageNotebookSharesResult();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('NoteStore_manageNotebookShares_result');

...
class NoteStore_listAccessibleBusinessNotebooks_result
{
    ...
    {
        return 'NoteStore_listAccessibleBusinessNotebooks_result';
    }
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i346 = 0; $_i346 < $_size342; ++$_i346) {
                            $elem347 = null;
                            $elem347 = new \EDAM\Types\Notebook();
                            $xfer += $elem347->read($input);
                            $this->success []= $elem347;
                        }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('NoteStore_listAccessibleBusinessNotebooks_result');
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter348) {

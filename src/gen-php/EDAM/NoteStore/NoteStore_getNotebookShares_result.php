...
class NoteStore_getNotebookShares_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\EDAM\NoteStore\ShareRelationships',
        ),
        1 => array(
            'var' => 'userException',
            'isRequired' => false,
    ...
    /**
     * @var \EDAM\NoteStore\ShareRelationships
     */
    public $success = null;
    /**
    ...
    {
        return 'NoteStore_getNotebookShares_result';
    }
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \EDAM\NoteStore\ShareRelationships();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('NoteStore_getNotebookShares_result');

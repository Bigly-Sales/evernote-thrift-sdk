...
class NoteStore_createOrUpdateNotebookShares_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\EDAM\NoteStore\CreateOrUpdateNotebookSharesResult',
        ),
        1 => array(
            'var' => 'userException',
            'isRequired' => false,
        ...
        4 => array(
            'var' => 'invalidContactsException',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\EDAM\Error\EDAMInvalidContactsException',
        ),
    );

    /**
     * @var \EDAM\NoteStore\CreateOrUpdateNotebookSharesResult
     */
    public $success = null;
    /**
    ...
    /**
     * @var \EDAM\Error\EDAMInvalidContactsException
     */
    public $invalidContactsException = null;
    ...
    public function __construct($vals = null)
    {
        if (is_array($vals)) {
            ...
            if (isset($vals['invalidContactsException'])) {
                $this->invalidContactsException = $vals['invalidContactsException'];
            }
        }
    }
    ...
    {
        return 'NoteStore_createOrUpdateNotebookShares_result';
    }
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \EDAM\NoteStore\CreateOrUpdateNotebookSharesResult();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->invalidContactsException = new \EDAM\Error\EDAMInvalidContactsException();
                        $xfer += $this->invalidContactsException->read($input);
                    } else {
                        $xfer += $input->skip($ftype);
                    }
                    break;
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('NoteStore_createOrUpdateNotebookShares_result');
        ...
        if ($this->invalidContactsException !== null) {
            $xfer += $output->writeFieldBegin('invalidContactsException', TType::STRUCT, 4);
            $xfer += $this->invalidContactsException->write($output);
            $xfer += $output->writeFieldEnd();
        }

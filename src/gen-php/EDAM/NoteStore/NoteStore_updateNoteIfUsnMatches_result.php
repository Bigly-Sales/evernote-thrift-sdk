...
class NoteStore_updateNoteIfUsnMatches_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\EDAM\NoteStore\UpdateNoteIfUsnMatchesResult',
        ),
        1 => array(
            'var' => 'userException',
            'isRequired' => false,
    ...
    /**
     * @var \EDAM\NoteStore\UpdateNoteIfUsnMatchesResult
     */
    public $success = null;
    /**
    ...
    {
        return 'NoteStore_updateNoteIfUsnMatches_result';
    }
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \EDAM\NoteStore\UpdateNoteIfUsnMatchesResult();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('NoteStore_updateNoteIfUsnMatches_result');

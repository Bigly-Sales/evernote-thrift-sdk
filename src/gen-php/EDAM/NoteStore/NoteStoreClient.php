...
class NoteStoreClient implements \EDAM\NoteStore\NoteStoreIf
{
    ...
    public function send_listAccessibleBusinessNotebooks($authenticationToken)
    {
        $args = new \EDAM\NoteStore\NoteStore_listAccessibleBusinessNotebooks_args();
        $args->authenticationToken = $authenticationToken;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
            ...
            $this->output_->writeMessageBegin('listAccessibleBusinessNotebooks', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_listAccessibleBusinessNotebooks()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_listAccessibleBusinessNotebooks_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_listAccessibleBusinessNotebooks_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("listAccessibleBusinessNotebooks failed: unknown result");
    }
    ...
    public function send_getNoteWithResultSpec($authenticationToken, $guid, \EDAM\NoteStore\NoteResultSpec $resultSpec)
    {
        $args = new \EDAM\NoteStore\NoteStore_getNoteWithResultSpec_args();
        $args->authenticationToken = $authenticationToken;
        $args->guid = $guid;
        $args->resultSpec = $resultSpec;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('getNoteWithResultSpec', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_getNoteWithResultSpec()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_getNoteWithResultSpec_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_getNoteWithResultSpec_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("getNoteWithResultSpec failed: unknown result");
    }
    ...
    public function send_shareNotebook($authenticationToken, \EDAM\Types\SharedNotebook $sharedNotebook, $message)
    {
        $args = new \EDAM\NoteStore\NoteStore_shareNotebook_args();
        $args->authenticationToken = $authenticationToken;
        ...
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('shareNotebook', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_shareNotebook()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_shareNotebook_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_shareNotebook_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("shareNotebook failed: unknown result");
    }
    ...
    public function send_createOrUpdateNotebookShares($authenticationToken, \EDAM\NoteStore\NotebookShareTemplate $shareTemplate)
    {
        $args = new \EDAM\NoteStore\NoteStore_createOrUpdateNotebookShares_args();
        $args->authenticationToken = $authenticationToken;
        ...
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('createOrUpdateNotebookShares', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_createOrUpdateNotebookShares()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_createOrUpdateNotebookShares_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_createOrUpdateNotebookShares_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        if ($result->invalidContactsException !== null) {
            throw $result->invalidContactsException;
        }
        throw new \Exception("createOrUpdateNotebookShares failed: unknown result");
    }
    ...
    public function send_setNotebookRecipientSettings($authenticationToken, $notebookGuid, \EDAM\Types\NotebookRecipientSettings $recipientSettings)
    {
        $args = new \EDAM\NoteStore\NoteStore_setNotebookRecipientSettings_args();
        $args->authenticationToken = $authenticationToken;
        $args->notebookGuid = $notebookGuid;
        ...
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('setNotebookRecipientSettings', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_setNotebookRecipientSettings()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_setNotebookRecipientSettings_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_setNotebookRecipientSettings_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("setNotebookRecipientSettings failed: unknown result");
    }
    ...
    public function send_authenticateToSharedNotebook($shareKeyOrGlobalId, $authenticationToken)
    {
    ...
    public function send_updateNoteIfUsnMatches($authenticationToken, \EDAM\Types\Note $note)
    {
        $args = new \EDAM\NoteStore\NoteStore_updateNoteIfUsnMatches_args();
        $args->authenticationToken = $authenticationToken;
        $args->note = $note;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('updateNoteIfUsnMatches', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_updateNoteIfUsnMatches()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_updateNoteIfUsnMatches_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_updateNoteIfUsnMatches_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("updateNoteIfUsnMatches failed: unknown result");
    }
    ...
    public function send_manageNotebookShares($authenticationToken, \EDAM\NoteStore\ManageNotebookSharesParameters $parameters)
    {
        $args = new \EDAM\NoteStore\NoteStore_manageNotebookShares_args();
        $args->authenticationToken = $authenticationToken;
        $args->parameters = $parameters;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('manageNotebookShares', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_manageNotebookShares()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_manageNotebookShares_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_manageNotebookShares_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("manageNotebookShares failed: unknown result");
    }
    ...
    public function send_getNotebookShares($authenticationToken, $notebookGuid)
    {
        $args = new \EDAM\NoteStore\NoteStore_getNotebookShares_args();
        $args->authenticationToken = $authenticationToken;
        $args->notebookGuid = $notebookGuid;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            ...
            $this->output_->writeMessageBegin('getNotebookShares', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_getNotebookShares()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\EDAM\NoteStore\NoteStore_getNotebookShares_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \EDAM\NoteStore\NoteStore_getNotebookShares_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("getNotebookShares failed: unknown result");
    }
}

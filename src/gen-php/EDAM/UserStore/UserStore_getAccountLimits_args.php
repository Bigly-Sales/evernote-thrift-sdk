...
class UserStore_getAccountLimits_args
{
    ...
    {
        return 'UserStore_getAccountLimits_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('UserStore_getAccountLimits_args');
        if ($this->serviceLevel !== null) {
            $xfer += $output->writeFieldBegin('serviceLevel', TType::I32, 1);
